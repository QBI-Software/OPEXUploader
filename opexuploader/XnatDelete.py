...
@author:    Alan Ho
@description:   This looks up the expt ID tag within the expts_removed.xlsx file and then removes the subsequent
                experiments from the database and project of interest
...
class XnatDeleter(XnatConnector):
    def __init__(self, pathtofile, expt, *args):
        XnatConnector.super(*args)
        self.pathtofile = pathtofile


    def delete_experiments(self, projectcode, exptid):
        subject = self.conn.select('/project/PROJECT/subject/SUBJECT')
